...
<head>
    <meta charset="utf-8">
    <title>Muzammil Ismail Portfolio</title>
...
<nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
    <a href="index.html" class="navbar-brand ml-lg-3">
        <h1 class="m-0 display-5"><span class="text-primary">Muzammil</span>Ismail</h1>
    </a>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 text-center text-lg-left">
                ...
                <h1 class="display-3 text-uppercase text-primary mb-2" style="-webkit-text-stroke: 2px #ffffff;">Muzammil Ismail</h1>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                ...
                <p style="text-align: justify">I am a skilled Laravel developer with expertise in full-stack web development. I have a strong understanding of the Laravel framework and its ecosystem. With several years of experience, I have successfully delivered high-quality projects, leveraging Laravel's robust features and best practices. I am passionate about creating efficient, scalable, and user-friendly web applications.</p>
                <div class="row mb-3">
                    <div class="col-sm-6 py-2"><h6>Name: <span class="text-secondary">Muzammil Ismail</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Birthday: <span class="text-secondary">07 April 1999</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Degree: <span class="text-secondary">Graduation (16 years)</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Phone: <span class="text-secondary">+92 3242526835</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Email: <span class="text-secondary">contact@muzammilismail.tech</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Address: <span class="text-secondary">Karachi, Pakistan</span></h6></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="border-left border-primary pt-2 pl-4 ml-2">
                    <div class="position-relative mb-4">
                        ...
                        <h5 class="font-weight-bold mb-1">BS Computer Science</h5>
                        <p class="mb-2"><strong>Sindh Madressatul Islam University</strong> | <small>2017 - 2021</small></p>
                        <p style="text-align: justify">I hold a Bachelor of Science degree in Computer Science with a strong foundation in computer programming, software development, and problem-solving. Through my academic studies, I have gained a comprehensive understanding of various programming languages, algorithms, data structures, and software engineering principles.</p>
                    </div>
                    <div class="position-relative mb-4">
                        <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                        <h5 class="font-weight-bold mb-1">Higher Secondary Certificate</h5>
                        <p class="mb-2"><strong>Sindh Muslim Science College</strong> | <small>2015 - 2017</small></p>
                        <p style="text-align: justify">Motivated and diligent HSC graduate with a strong academic background and a passion for continuous learning. Completed the Higher Secondary Certificate with distinction, demonstrating excellent academic performance and a commitment to personal growth. </p>
                    </div>
                    <div class="position-relative mb-4">
                        <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                        <h5 class="font-weight-bold mb-1">Secondary School Certificate</h5>
                        <p class="mb-2"><strong>White Rose Grammar School</strong> | <small>2013 - 2015</small></p>
                        <p style="text-align: justify"> Possesses a strong understanding of core subjects and seeks to leverage this educational milestone to pursue higher studies and build a successful career in tech industry.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="border-left border-primary pt-2 pl-4 ml-2">
                    <div class="position-relative mb-4">
                        ...
                        <p class="mb-2"><strong>Laravel Developer</strong> | <small>2022 - Present</small></p>
                        <p style="text-align: justify">As a full stack developer, I have the skills and knowledge to work on both the frontend and backend aspects of web development. My responsibilities encompass various areas of the web development process.</p>
                    </div>
                    <div class="position-relative mb-4">
                        <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                    ...
                    <div class="position-relative mb-4">
                        <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                        <h5 class="font-weight-bold mb-1">Instructor/Teacher</h5>
                        <p class="mb-2"><strong>Saqib Rose Academy</strong> | <small>2017 - 2022</small></p>
                        <p style="text-align: justify">Dedicated and experienced Mathematics Instructor with a passion for teaching and a strong background in mathematics. Skilled in creating engaging learning environments and fostering a positive classroom atmosphere.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="contact-form text-center">
                    ...
                    <form method="POST" action="/contact-details">
                        ...
                        <div class="form-row">
                            ...
                            <div class="control-group col-sm-4">
                                <input type="text" class="form-control p-4" id="number" name="number" placeholder="Your Contact Number"
